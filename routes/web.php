...
use App\Http\Controllers\CompetenceLevelController;
...
use App\Http\Controllers\HostFirmConfigController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('host-firm-configs', HostFirmConfigController::class);
