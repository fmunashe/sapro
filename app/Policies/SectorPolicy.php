...
class SectorPolicy
{
    ...
    {
        return ($user->type == UserTypeEnum::ADMIN || $user->type == UserTypeEnum::SUPER_ADMIN || $sector->saproId == $user->saproId);
    }

    /**
     * Determine whether the user can view the model.
     */
    public function approveSector(User $user, Sector $sector): bool
    {
