...
<div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('fact-external-clients.index')}}" method="post">
                @csrf
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="standard-modalLabel">Fact External Clients Registration</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="saproId" type="text"
                                       ...
                                       name="saproId" value="{{ old('saproId') }}" autocomplete="saproId" autofocus
                                       required>
                        ...
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input id="personalEmail" type="email"
                                   ...
                                   name="personalEmail" value="{{ old('personalEmail') }}" autocomplete="personalEmail"
                                   required>
