 ...
 */
?>
<div id="edit_fact_external_client_modal_{{$client->externalClientId}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('fact-external-clients.update',[$client->externalClientId])}}" method="post">
                @csrf
                @method('put')
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="standard-modalLabel">{{ __('Update Fact External Client Details') }}</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <select id="seniorityLevelId" type="text"
                                        ...
                                        value="{{ $client->seniorityLevelId }}" autocomplete="seniorityLevelId" autofocus
                                        required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <select id="contractStatusId" type="text"
                                        ...
                                        value="{{ $client->contractStatusId }}" autocomplete="contractStatusId" autofocus
                                        required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <select id="specialisationId" type="text"
                                        ...
                                        value="{{ $client->specialisationId }}" autocomplete="specialisationId" autofocus
                                        required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="saproId" type="text"
                                       ...
                                       name="saproId" value="{{ $client->saproId }}" autocomplete="saproId" autofocus
                                       required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                       name="name" value="{{$client->name }}" autocomplete="name" autofocus required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="surname" type="text"
                                       ...
                                       name="surname" value="{{ $client->surname }}" autocomplete="surname" autofocus
                                       required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('Personal Email') }} &nbsp;&nbsp;&nbsp;</span>
                                </div>
                                <input id="personalEmail" type="email"
                                       class="form-control @error('personalEmail') is-invalid @enderror"
                                       name="personalEmail" value="{{$client->personalEmail }}" autocomplete="personalEmail"
                                       required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('Sapro Email') }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </div>
                                <input id="saproEmail" type="email"
                                       class="form-control @error('saproEmail') is-invalid @enderror"
                                       name="saproEmail" value="{{ $client->saproEmail }}" autocomplete="saproEmail"
                                       required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="saproContractStartDate" type="date"
                                       ...
                                       name="saproContractStartDate" value="{{ $client->saproContractStartDate }}"
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="saproContractEndDate" type="date"
                                       ...
                                       name="saproContractEndDate" value="{{ $client->saproContractEndDate }}"
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="location" type="text"
                                       ...
                                       name="location" value="{{ $client->location }}" autocomplete="location"
                                       required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="nationality" type="text"
                                       ...
                                       name="nationality" value="{{ $client->nationality }}" autocomplete="nationality"
                                       required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="articleFirm" type="text"
                                       ...
                                       name="articleFirm" value="{{ $client->articleFirm }}" autocomplete="articleFirm"
                                       required>
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="highestQualification" type="text"
                                       ...
                                       name="highestQualification" value="{{ $client->highestQualification }}"
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="travel" type="text"
                               ...
                               name="travel" value="{{ $client->travel }}" autocomplete="travel"
                               required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success"><i class="mdi mdi-content-save"></i> Update Fact External Client
                        Details
                    </button>
                </div>
            </form>
