...
<div id="delete_professional_experience_modal_{{$experience->professionalExperienceId}}" class="modal fade"
     tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('professional-experience.destroy',[$experience->professionalExperienceId])}}"
