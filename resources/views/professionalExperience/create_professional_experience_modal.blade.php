...
<div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('professional-experience.store')}}" method="post">
                @csrf
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="standard-modalLabel">New Professional Experience</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="professionalExperience" type="text" class="form-control @error('professionalExperience') is-invalid @enderror"
                               name="professionalExperience" value="{{ old('professionalExperience') }}" autocomplete="professionalExperience" autofocus required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success"><i class="mdi mdi-content-save"></i> Add Professional Experience
                    </button>
                </div>
            </form>
        </div>
