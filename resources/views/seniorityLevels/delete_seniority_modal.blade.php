...
<div id="delete_seniority_modal_{{$level->seniorityLevelId}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('seniority-levels.destroy',[$level->seniorityLevelId])}}" method="post" class="m-0">
                @csrf
                @method('delete')
