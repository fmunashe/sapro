...
<div id="delete_international_experience_modal_{{$experience->internationalExperienceId}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('international-experience.destroy',[$experience->internationalExperienceId])}}" method="post" class="m-0">
                @csrf
                @method('delete')
