        ...
        <div class="modal-content">
            <form action="{{route('scheduling.store')}}" method="post">
                ...
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="standard-modalLabel">New Scheduling</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="year" type="date" class="form-control @error('year') is-invalid @enderror"
                               name="year" value="{{ old('year') }}" autocomplete="year" autofocus required>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="bsHostFirmCode" type="text"
                               ...
                               name="bsHostFirmCode" value="{{ old('bsHostFirmCode') }}" autocomplete="bsHostFirmCode"
                               autofocus required>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="bsStartDate" type="date" class="form-control @error('bsStartDate') is-invalid @enderror"
                               name="bsStartDate" value="{{ old('bsStartDate') }}" autocomplete="bsStartDate" autofocus
                               required>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="bsEndDate" type="date" class="form-control @error('bsEndDate') is-invalid @enderror"
                               name="bsEndDate" value="{{ old('bsEndDate') }}" autocomplete="bsEndDate" required>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="postBsHostFirmCode" type="text"
                               ...
                               name="postBsHostFirmCode" value="{{ old('postBsHostFirmCode') }}"
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="postBsStartDate" type="date"
                               ...
                               name="postBsStartDate" value="{{ old('postBsStartDate') }}"
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="postBsEndDate" type="date"
                               ...
                               name="postBsEndDate" value="{{ old('postBsEndDate') }}"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success"><i class="mdi mdi-content-save"></i> Add Scheduling
                    </button>
                </div>
            </form>
        </div>
