...
<div id="delete_specialisation_modal_{{$specialisation->specialisationId}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('specialisation.destroy',[$specialisation->specialisationId])}}" method="post" class="m-0">
                @csrf
                @method('delete')
