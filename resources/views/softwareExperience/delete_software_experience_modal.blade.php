...
<div id="delete_software_experience_modal_{{$experience->softwareExperienceId}}" class="modal fade"
     tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('software-experience.destroy',[$experience->softwareExperienceId])}}"
