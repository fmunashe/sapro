...
<div id="delete_listed_clients_modal_{{$listedClient->listedClientId}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('listed-clients.destroy',[$listedClient->listedClientId])}}" method="post" class="m-0">
                @csrf
                @method('delete')
