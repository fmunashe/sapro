 ...
 */
?>
<div id="edit_firm_experience_modal_{{$experience->firmExperienceId}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('firm-experience.update',[$experience->firmExperienceId])}}" method="post">
                @csrf
                @method('put')
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="standard-modalLabel">{{ __('Update Firm Experience Details') }}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="company" type="text" class="form-control @error('company') is-invalid @enderror"
                               name="company" value="{{ $experience->company }}" autocomplete="company" autofocus required>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="level" type="text" class="form-control @error('level') is-invalid @enderror"
                               name="level" value="{{ $experience->level }}" autocomplete="level" autofocus required>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="startPeriod" type="date" class="form-control @error('startPeriod') is-invalid @enderror"
                               name="startPeriod" value="{{ $experience->startPeriod }}" autocomplete="startPeriod" required>
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input id="endPeriod" type="date" class="form-control @error('endPeriod') is-invalid @enderror"
                               name="endPeriod" value="{{ $experience->endPeriod }}" autocomplete="endPeriod" required>
