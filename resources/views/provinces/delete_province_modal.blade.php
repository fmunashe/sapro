...
<div id="delete_province_modal_{{$province->id}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('provinces.destroy',[$province->id])}}" method="post" class="m-0">
                @csrf
                @method('delete')
