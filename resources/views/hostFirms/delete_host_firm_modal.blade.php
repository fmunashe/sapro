...
<div id="delete_host_firm_modal_{{$hostFirm->hostFirmId}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('host-firms.destroy',[$hostFirm->hostFirmId])}}" method="post" class="m-0">
                @csrf
                @method('delete')
