        ...
        <div class="modal-content">
            <form action="{{route('cities.store')}}" method="post">
                ...
                <div class="modal-header modal-colored-header bg-success">
                    <h4 class="modal-title" id="standard-modalLabel">New Pro Location</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success"><i class="mdi mdi-content-save"></i> Add Pro Location
                    </button>
                </div>
            </form>
        </div>
