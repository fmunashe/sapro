...
<div id="delete_additional_experience_category_modal_{{$category->id}}" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="danger-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{route('additional-experience-categories.destroy',[$category->id])}}" method="post" class="m-0">
                @csrf
                @method('delete')
